...
class App extends Component {
	...
	componentWillMount = async () => {
		...
		*/
		...
		const portfolioBucket = Cosmic().bucket({
			slug: 'dac-portfolio-site',
			read_key: 'Swkl7YdIB23IQdoZqFnd0QOIrQClp0pQXN2XAUCU8fGs0Jdz8e',
			write_key: 'PVgtgRyVtBd1Okaw0Ekyjevk11ppsb92gKxYT6pD4AdaFh0RKM',
		})
		...
		console.log(aboutContent.object.metadata)
